...
public class InternalReLiqVacacionales extends javax.swing.JInternalFrame {
    ...
    private static InternalReLiqVacacionales instancia=null;
    
    
    public InternalReLiqVacacionales() throws ClassNotFoundException, SQLException {
        initComponents();
    ...
    public static InternalReLiqVacacionales getInstancia() {
        return instancia;
    }

    public static void setInstancia(InternalReLiqVacacionales instancia) {
        InternalReLiqVacacionales.instancia = instancia;
    }
    
    
   public static InternalReLiqVacacionales instancia() throws ClassNotFoundException, SQLException
   {    
         if (instancia== null)
         {
            instancia = new InternalReLiqVacacionales();
         }
         return instancia;
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Re-Liquidación de Salarios Vacacionales");
                    ...
                    if(funcionarios!=null){
                        if(funcionarios.size()>0){
                            for(Funcionario k: funcionarios){
                                InternalReLiqVacacionales.instancia().getTxtNombre().setText(k.getNomCompletoApe());
                                InternalReLiqVacacionales.instancia().getTxtNumFunc().setText(k.getCodFunc().toString());
                                InternalReLiqVacacionales.instancia().repaint();
                                InternalReLiqVacacionales.instancia().getTxtNumFunc().paint( InternalReLiqVacacionales.instancia().getTxtNumFunc().getGraphics());
                                InternalReLiqVacacionales.instancia().getTxtNombre().paint( InternalReLiqVacacionales.instancia().getTxtNombre().getGraphics());
                                InternalReLiqVacacionales.instancia().revalidate();
                                this.persLiq.liquidar(k,fecha,4,false);
                            }
                            InternalReLiqVacacionales.instancia().getTxtNombre().setText("Liquidación Finalizada");
                            InternalReLiqVacacionales.instancia().getTxtNumFunc().setText("");
                            InternalReLiqVacacionales.instancia().repaint();
                            InternalReLiqVacacionales.instancia().getTxtNombre().paint( InternalReLiqVacacionales.instancia().getTxtNombre().getGraphics());
                            InternalReLiqVacacionales.instancia().getTxtNumFunc().paint( InternalReLiqVacacionales.instancia().getTxtNumFunc().getGraphics());
                            InternalReLiqVacacionales.instancia().revalidate();
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        ...
        try {
            ...
            Logger.getLogger(InternalReLiqVacacionales.class.getName()).log(Level.SEVERE, null, ex);
        }
